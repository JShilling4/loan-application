        ...
        >
            ...
            <div class="optOut-container">
                <check-box
                    ...
                    v-model:checked="localCoborrowerIdentity.demographics.isOptingOut"
                />
            </div>

            <question-slider
                v-if="localCoborrowerIdentity.demographics.isOptingOut === false"
            ...
            >
                ...
                <div v-if="activeSet === 1" class="input-group">
                    ...
                    <multi-select
                        ...
                        :can-clear="false"
                        class="multiselect"
                        v-model="localCoborrowerIdentity.demographics.ethnicity"
                    />
                </div>
                ...
                <div v-if="activeSet === 2" class="input-group">
                    ...
                    <multi-select
                        ...
                        :can-clear="false"
                        class="multiselect"
                        v-model="localCoborrowerIdentity.demographics.gender"
                    />
                </div>
                ...
                <div v-if="activeSet === 3" class="input-group">
                    ...
                    <multi-select
                        ...
                        :can-clear="false"
                        class="multiselect"
                        v-model="localCoborrowerIdentity.demographics.race"
                    />
                </div>
            </question-slider>
