		...
		<form class="pageForm">
			...
			<fieldset class="inline-form-group">
				...
				<div class="input-group">
					<app-label for="ssn" class-list="dark">
				...
				<!-- DOB -->
				<div class="input-group">
					<app-label for="dob" class-list="dark">
						Date of Birth
					</app-label>
					<text-field
						type="text"
...
export default {
	...
	mixins: [income],
	components: {
		"app-modal": () => import("@/components/shared/AppModal.vue"),
		"text-field": () => import("@/components/shared/inputs/TextField.vue"),
		"learn-more-link": () =>
			import("@/components/shared/LearnMoreLink.vue"),
		"check-box": () => import("@/components/shared/inputs/CheckBox.vue"),
