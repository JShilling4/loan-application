    ...
    <div class="page-wrapper">
                ...
                <div class="faq-container">
                    ...
                    >
                        <div class="question-container">
                            ...
                            <i
                                v-if="faq.videoUrl !== null"
                                class="fas fa-play-circle playIcon"
                            ></i>
                            <i class="fas fa-chevron-right indicatorIcon"></i>
                        </div>

                        <div
                            :ref="`answerContainer${index}`"
        ...
        <section class="unansweredQuestion-container">
            <div class="container chatTrigger">
                <span
                    class="text"
                    data-i18n="dontSeeYourQuestion"
                >Don't see your question?</span>
...
export default {
    ...
    computed: {
        selectedTopicIndex() {
            return faqData.topics.findIndex(
                (topic) => topic.id == this.selectedTopicId
            );
        },
        selectedTopicName() {
            return faqData.topics.find(
                (topic) => topic.id == this.selectedTopicId
            ).name;
        },
    },
    ...
    methods: {
        getFaqsByTopicId(topicId) {
            ...
            if (topicId !== 0) {
                this.faqList = faqData.faqs.filter(
...
section.faqSection {
    ...
    .faq {
        ...
        .answer-container {
            ...
            opacity: 0;
            overflow-y: hidden;
            transition: height $accordion-transition-time,
                padding $accordion-transition-time,
